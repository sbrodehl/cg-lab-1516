...
std::vector<ParameterTriangle *> TriangulationAlgorithm::triangulate(std::vector<std::vector<QVector2D*>> polygon_in){
...
void TriangulationAlgorithm::handleVertex(Vertex* p, std::set<Line*, yPriorityLine> SL, std::map<Line*, Vertex*> helpers){
...
void TriangulationAlgorithm::handleStart(Vertex* p, std::set<Line*, yPriorityLine> SL, std::map<Line*, Vertex*> helpers){
    int idx = getIndex(vertices, p);
    SL.insert(lines[idx]);
    helpers[lines[idx]]= p;
}

void TriangulationAlgorithm::handleEnd(Vertex* p, std::set<Line*, yPriorityLine> SL, std::map<Line*, Vertex*> helpers){
...
void TriangulationAlgorithm::handleSplit(Vertex* p, std::set<Line*, yPriorityLine> SL, std::map<Line*, Vertex*> helpers){
...
void TriangulationAlgorithm::handleMerge(Vertex* p, std::set<Line*, yPriorityLine> SL, std::map<Line*, Vertex*> helpers){
    int idx = getIndex(vertices, p->getNeighbor(0));
    Line* e = lines[idx];
...
void TriangulationAlgorithm::handleRegular(Vertex* p, std::set<Line*, yPriorityLine> SL, std::map<Line*, Vertex*> helpers){
